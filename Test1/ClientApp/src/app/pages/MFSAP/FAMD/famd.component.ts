...
import { Service, OrderInfo, Employee, State, State2, State3, State4, State5, State6, State7, State8, State11} from './app.service';
...
@Component({
  templateUrl: 'famd.component.html',
  providers: [ImateDataService, Service]
})

export class FAMDComponent {
  ...
  constructor(private dataService: ImateDataService, service: Service, http: HttpClient, imInfo: ImateInfo, private appInfo: AppInfoService) {
    // dropdownbox
    appInfo.title = AppInfoService.APP_TITLE + " | 농가배송등록수정";
