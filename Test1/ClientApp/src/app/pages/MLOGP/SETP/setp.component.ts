...
import { Service, VsGubun, CarSeq, CSpart } from '../SETP/app.service';
import {
  DxDataGridComponent,
  DxDateBoxModule,
  DxFormComponent, 
...
@Component({
  templateUrl: 'setp.component.html',
  providers: [ImateDataService, Service]
})



export class SETPComponent {
 ...
 * */
  ...
  constructor(private appConfig: AppConfigService, private dataService: ImateDataService, service: Service, private appInfo: AppInfoService, private imInfo: ImateInfo, private authService: AuthService) {
    appInfo.title = AppInfoService.APP_TITLE + " | 2차운송사지정-임가공";
