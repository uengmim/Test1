...
import { Service, Data, Data2, CarSeq } from '../ALSQ/app.service';
import {
  DxDataGridComponent,
  DxDateBoxModule,
  DxFormComponent,
...
@Component({
  templateUrl: 'alsq.component.html',
  providers: [ImateDataService, Service]
})



export class ALSQComponent {
 ...
 * */
  ...
  constructor(private appConfig: AppConfigService, private dataService: ImateDataService, service: Service, private appInfo: AppInfoService, private imInfo: ImateInfo, private authService: AuthService) {
    appInfo.title = AppInfoService.APP_TITLE + " | 2차배차할당 현황-물류(비료,고체화학)";
