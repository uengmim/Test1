...
import { Service, Employee, Product, Option } from '../ShippingRegistration/app.service';
...
@Component({
  templateUrl: 'ShippingRegistration.component.html',
  providers: [ImateDataService, Service],

})

export class ShippingRegistrationComponent {
