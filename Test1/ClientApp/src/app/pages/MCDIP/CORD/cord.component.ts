...
export class CORDComponent {
  ...
  public async createOrder() {
    ...
    var zsds3100Model = new ZSDS3100Model(data.AUART, "1000", "10", "30", "", "", data.VDATU, new Date, "0000100038", "", data.KUNWE, data.TDLNR, data.TDLNR2, data.INCO1, "", data.VSBED, "1", "", "", "", data.ZCARTYPE, data.ZCARNO, data.ZDRIVER, data.ZPHONE, data.ZUNLOAD, "", "", "", "", "", "");
    var zsds6001Model = new ZSDS6001Model("10", data.MATNR, data.KWMENG, "", "1000", data.LGORT, 0, 0, "", data.VKAUS);
