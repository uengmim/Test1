...
import { Service, Data, OilChemical, Product, Client } from '../CSWE/app.service'
import {
  DxDataGridComponent,
  DxDateBoxModule,
...
@Component({
  templateUrl: 'cswe.component.html',
  providers: [ImateDataService, Service]
})



export class CSWEComponent {
  ...
  constructor(private dataService: ImateDataService, service: Service, private appInfo: AppInfoService) {
    appInfo.title = AppInfoService.APP_TITLE + " | 공차, 총량";
    //정보
    this.data = service.getData();
    this.oilChemical = service.getOilChemical();
